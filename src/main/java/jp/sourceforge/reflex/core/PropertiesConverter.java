 ...
 * compact form than java.util.Map. <p/>
 * <p>
...
public class PropertiesConverter implements Converter {
	...
	private final Field defaultsField = Fields.find(Properties.class,
			"defaults");
	...
	public void marshal(Object source, HierarchicalStreamWriter writer,
		...
		Properties defaults = (Properties) Fields.read(defaultsField,
				properties);
		if (defaults != null) {
